...
<p>Данные для доступа к базе данных</p>
<form method="post" action="#">
    <p>Данные для доступа к базе данных:</p>
    <p><input type="text" name="DB_SERVER" placeholder="Сервер" value="localhost"/></p>
    <p><input type="text" name="DB_USER" placeholder="Пользователь" value="sa" /></p>
    <p><input type="text" name="DB_PASSWORD" placeholder="Пароль" value="" /></p>
